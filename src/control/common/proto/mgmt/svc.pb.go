...
type GroupUpdateReq struct {
	...
	ModOp                uint32                   `protobuf:"varint,2,opt,name=mod_op,json=modOp,proto3" json:"mod_op,omitempty"`
	Servers              []*GroupUpdateReq_Server `protobuf:"bytes,3,rep,name=servers,proto3" json:"servers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *GroupUpdateReq) GetModOp() uint32 {
	if m != nil {
		return m.ModOp
	}
	return 0
...
var fileDescriptor_e5747b2e02f0c537 = []byte{
	...
	,
}
